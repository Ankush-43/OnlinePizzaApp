...
public class IPizzaOrderController {
	...
	public String bookOrderInfo(@PathVariable("cartid")int cartId,@PathVariable("customerId") int customerId,@PathVariable("couponId") int couponId) throws CartIdNotFoundException
	{
	  return service.bookOrderInfo(cartId, customerId,couponId);
	}
    ...
    @GetMapping("/viewOrderByOrderandCustomerId/{customerId}/{orderId}")
     public Optional<Order> viewOrder(@PathVariable("customerId") int customerId, @PathVariable("orderId") int orderid)
    {
